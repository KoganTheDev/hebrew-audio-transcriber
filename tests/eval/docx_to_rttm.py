...
def align_blocks(
    ...
    Returns (bubbles, matched_line_count, dropped_line_count). See the
    ...
    return bubbles, matched, dropped
...
def build_rttm_from_blocks(
    ...
    """Align + merge + render. Returns (rttm_text, matched, dropped)."""
    bubbles, matched, dropped = align_blocks(
    ...
    return turns_to_rttm(turns, file_id), matched, dropped
...
def run_validation(
    ...
    bubbles, matched, dropped = align_blocks(synthetic_blocks, segments, pad=pad)
...
def main(argv: list[str] | None = None) -> int:
    ...
    rttm, matched, dropped = build_rttm_from_blocks(
        blocks,
        segments,
